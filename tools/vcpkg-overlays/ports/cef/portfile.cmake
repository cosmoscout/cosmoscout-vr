...
# Also install the full runtime contents including all necessary files
file(GLOB CEF_RUNTIME_DLLS "${SOURCE_PATH}/Release/*.dll")
file(GLOB CEF_RUNTIME_SO   "${SOURCE_PATH}/Release/*.so*")
file(GLOB CEF_RUNTIME_DAT  "${SOURCE_PATH}/Release/*.dat")
file(GLOB CEF_RUNTIME_BIN  "${SOURCE_PATH}/Release/*.bin")
file(GLOB CEF_RUNTIME_JSON "${SOURCE_PATH}/Release/*.json")

if(NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
  file(COPY ${CEF_RUNTIME_DLLS} DESTINATION "${CURRENT_PACKAGES_DIR}/bin")
  file(COPY ${CEF_RUNTIME_SO}   DESTINATION "${CURRENT_PACKAGES_DIR}/bin")
  file(COPY ${CEF_RUNTIME_DAT}  DESTINATION "${CURRENT_PACKAGES_DIR}/bin")
  file(COPY ${CEF_RUNTIME_BIN}  DESTINATION "${CURRENT_PACKAGES_DIR}/bin")
  file(COPY ${CEF_RUNTIME_JSON} DESTINATION "${CURRENT_PACKAGES_DIR}/bin")
endif ()

if(NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
  file(COPY ${CEF_RUNTIME_DLLS} DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
  file(COPY ${CEF_RUNTIME_SO}   DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
  file(COPY ${CEF_RUNTIME_DAT}  DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
  file(COPY ${CEF_RUNTIME_BIN}  DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
  file(COPY ${CEF_RUNTIME_JSON} DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
endif ()
