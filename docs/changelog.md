...
* An interactive JavaScript console has been added to the user interface. This can be used control CosmoScout VR with scripts.
...
* [spdlog](https://github.com/gabime/spdlog) is now used as logging library. The logger will print colourful messages to the console and store it's messages in a file called `cosmoscout.log`. 
...
* More CSS variables. This cleans our CSS quite a bit.
