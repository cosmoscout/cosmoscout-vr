...
void Plugin::setupNodeEditor(uint16_t port) {
  ...
  factory.registerStyleSheet(R"HTML(<link type="text/css" rel="stylesheet" href="third-party/css/FormatNumber.css" />)HTML");
  factory.registerLibrary(R"HTML(<script type="module" src="third-party/js/FormatNumberWithColor.js"></script>)HTML");
