...
#ifndef CSP_VISUAL_QUERY_ADDIMAGE2D_NODE_HPP
#define CSP_VISUAL_QUERY_ADDIMAGE2D_NODE_HPP
...
/// The AddImage2DNode calculates the difference between the first and second input.
...
class AddImage2D : public csl::nodeeditor::Node {
 public:
  // static interface ------------------------------------------------------------------------------

  static const std::string                  sName;
  static std::string                        sSource();
  static std::unique_ptr<AddImage2D> sCreate();
  ...
  /// Whenever the value of the node is required, the AddImage2DNode will send a message to
...
#endif // CSP_VISUAL_QUERY_ADDIMAGE2D_NODE_HPP