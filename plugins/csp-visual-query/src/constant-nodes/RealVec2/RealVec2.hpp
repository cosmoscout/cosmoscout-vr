...
#ifndef CSP_VISUAL_QUERY_RealVec2_NUMBER_NODE_HPP
#define CSP_VISUAL_QUERY_RealVec2_NUMBER_NODE_HPP

#include "../../../../csl-node-editor/src/Node.hpp"

namespace csp::visualquery {

/// The RealVec2 provides a user defined vector.
/// The node will write a new value to its output whenever the user edits the
...
/// loaded.
class RealVec2 : public csl::nodeeditor::Node {
 public:
  // static interface ------------------------------------------------------------------------------

  static const std::string           sName;
  static std::string                 sSource();
  static std::unique_ptr<RealVec2> sCreate();
  ...
  /// Whenever the user changes the number value of the node, the RealVec2 will send a message to
...
#endif // CSP_VISUAL_QUERY_RealVec2_NUMBER_NODE_HPP