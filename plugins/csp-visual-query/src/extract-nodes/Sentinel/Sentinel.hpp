...
#ifndef CSP_VISUAL_QUERY_SENTINEL_HPP
#define CSP_VISUAL_QUERY_SENTINEL_HPP
...
class Sentinel : public csl::nodeeditor::Node {
 public:
  // static interface ------------------------------------------------------------------------------

  static const std::string         sName;
  static std::string               sSource();
  static std::unique_ptr<Sentinel> sCreate();
...
#endif // CSP_VISUAL_QUERY_SENTINEL_HPP