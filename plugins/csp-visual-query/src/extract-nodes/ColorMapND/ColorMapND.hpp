...
#ifndef CSP_VISUAL_QUERY_COLORMAPND_HPP
#define CSP_VISUAL_QUERY_COLORMAPND_HPP
...
class ColorMapND : public csl::nodeeditor::Node {
 public:
  // static interface ------------------------------------------------------------------------------

  static const std::string           sName;
  static std::string                 sSource();
  static std::unique_ptr<ColorMapND> sCreate();
 ...
 private:
  ...
  std::vector<double> mDimensionWeights;
  float               mHue = 0.f;
};

} // namespace csp::visualquery

#endif // CSP_VISUAL_QUERY_COLORMAPND_HPP