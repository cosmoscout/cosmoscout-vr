...
#ifndef CSL_OGC_WEB_MAP_LAYER_HPP
#define CSL_OGC_WEB_MAP_LAYER_HPP
...
class CSL_OGC_EXPORT WebMapLayer {
 public:
  ...
  struct Style {
    ...
    std::optional<std::string> mLegendUrl;
...
#endif // CSL_OGC_WEB_MAP_LAYER_HPP
