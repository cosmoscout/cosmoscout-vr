...
class CSL_NODE_EDITOR_EXPORT Node {
 public:
  ...
  /// This method gets called once every frame regardless of whether the node has been modified or
  /// not. This is useful for nodes which need to perform some logic every frame.
  virtual void tick() {};
