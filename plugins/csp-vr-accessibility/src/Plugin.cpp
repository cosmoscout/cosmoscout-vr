...
void from_json(nlohmann::json const& j, Plugin::Settings& o) {
  ...
  cs::core::Settings::deserialize(
      j, "vignetteLowerVelocityThreshold", o.mFovVignetteLowerVelocityThreshold);
  cs::core::Settings::deserialize(
      j, "vignetteUpperVelocityThreshold", o.mFovVignetteUpperVelocityThreshold);
...
void Plugin::init() {
  ...
  mGuiManager->getGui()->registerCallback("floorGrid.setSize",
      ...
      std::function([this](double value) {
        mPluginSettings->mSize = static_cast<float>(std::pow(2, value));
      }));
  mPluginSettings->mSize.connectAndTouch([this](float value) {
  ...
  mGuiManager->getGui()->registerCallback("floorGrid.setOffset",
      "Value to adjust downward offset of the grid.", std::function([this](double value) {
        mPluginSettings->mOffset = static_cast<float>(value);
      }));
  ...
  mGuiManager->getGui()->registerCallback("floorGrid.setColor",
      "Value to adjust color of the grid.", std::function([this](std::string value) {
        mPluginSettings->mColor = static_cast<std::string>(value);
      }));
  mPluginSettings->mColor.connectAndTouch([this](std::string value) {
  ...
  mGuiManager->getGui()->registerCallback("fovVignette.setEnableDynamicRadius",
      ...
      std::function(
          [this](bool enable) { mPluginSettings->mFovVignetteUseDynamicRadius = enable; }));
  mPluginSettings->mFovVignetteUseDynamicRadius.connectAndTouch([this](bool enable) {
  ...
  mGuiManager->getGui()->registerCallback("fovVignette.setEnableVerticalOnly",
      "Only use a vertical vignette, instead of a circular.", std::function([this](bool enable) {
        mPluginSettings->mFovVignetteUseVerticalOnly = enable;
      }));
  mPluginSettings->mFovVignetteUseVerticalOnly.connectAndTouch([this](bool enable) {
  ...
  mGuiManager->getGui()->registerCallback("fovVignette.setInnerRadius",
      ...
      std::function([this](double value) {
        mPluginSettings->mFovVignetteInnerRadius = static_cast<float>(value);
      }));
  ...
  mGuiManager->getGui()->registerCallback("fovVignette.setOuterRadius",
      ...
      std::function([this](double value) {
        mPluginSettings->mFovVignetteOuterRadius = static_cast<float>(value);
      }));
  ...
  mGuiManager->getGui()->registerCallback("fovVignette.setColor",
      "Value to adjust the color of the vignette.", std::function([this](std::string value) {
        mPluginSettings->mFovVignetteColor = static_cast<std::string>(value);
      }));
  mPluginSettings->mFovVignetteColor.connectAndTouch([this](std::string value) {
  ...
  mGuiManager->getGui()->registerCallback("fovVignette.setLowerThreshold",
      ...
      std::function([this](double value) {
        mPluginSettings->mFovVignetteLowerVelocityThreshold = static_cast<float>(value);
      }));
  ...
  mGuiManager->getGui()->registerCallback("fovVignette.setUpperThreshold",
      ...
      std::function([this](double value) {
        mPluginSettings->mFovVignetteUpperVelocityThreshold = static_cast<float>(value);
      }));
...
void Plugin::update() {
  ...
  if (resetColorPicker) {
    ...
    mGuiManager->getGui()->callJavascript(
        "CosmoScout.floorGrid.setColorValue", mPluginSettings->mColor.get());
    // reset vignette color into picker
    mGuiManager->getGui()->callJavascript(
        "CosmoScout.fovVignette.setColorValue", mPluginSettings->mFovVignetteColor.get());
    // clear flag
