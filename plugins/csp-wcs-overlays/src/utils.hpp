...
#ifndef CSP_WCS_UTILS_HPP
#define CSP_WCS_UTILS_HPP
...
/// Struct for the duration of the WCS time step.
...
struct TimeInterval {
  ...
  Duration                 mSampleDuration; ///< The duration of one sample in WCS interval.
...
/// A) Handling the format used by WCS for describing temporal data
