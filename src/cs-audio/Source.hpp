...
/// @brief This is the derived source class for non-streaming sources. This means that the whole
/// file is being read and written into the buffer. This has the benefit that buffers can be shared
/// among all non-streaming sources. This is done via the BufferManager.
class CS_AUDIO_EXPORT Source : public SourceBase {
 public:
  ...
  /// calls
  Source(std::shared_ptr<BufferManager> bufferManager, std::string file,
