...
class CS_AUDIO_EXPORT StreamingSource : public SourceBase {
 public:
  ...
  /// @brief This Constructor will create a dummy StreamingSource which is used when a member of a
  /// cluster tries to create a StreamingSource. Doing this will disable any functionality of this
  /// class.
  StreamingSource();
  ~StreamingSource();
