...
# The build directory.
BUILD_DIR="$CURRENT_DIR/build/mingw-externals-$BUILD_TYPE"

# The install directory.
INSTALL_DIR="$CURRENT_DIR/install/mingw-externals-$BUILD_TYPE"
...
cmake "${CMAKE_FLAGS[@]}" -DCMAKE_INSTALL_PREFIX="$INSTALL_DIR" \
      ...
      -DCARES_LIBRARY="$INSTALL_DIR/bin/libcares.dll" \
...
cmake "${CMAKE_FLAGS[@]}" -DCMAKE_INSTALL_PREFIX="$INSTALL_DIR" \
      ...
      -DCURL_LIBRARY="$INSTALL_DIR/bin/$CURL_LIB" \
